...
// Classification: C — local implementation. shadcn sidebar is mostly local React
// context + layout; no Radix primitives. The mobile variant re-uses our Sheet.
// Cookie persistence, keyboard shortcut (Ctrl/Cmd+B), and all shadcn exports are
// preserved. useIsMobile is inlined via matchMedia. asChild is dropped throughout
// (React Aria has no Slot); SidebarMenuButton/SidebarGroupLabel/etc. expose
// className-based composition instead.
