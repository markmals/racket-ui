...
let sheetContentVariants = cva({
    base: "fixed z-50 flex flex-col gap-4 bg-background shadow-lg data-[entering]:animate-in data-[entering]:duration-500 data-[exiting]:animate-out data-[exiting]:duration-300",
    variants: {
        side: {
...
function SheetContent({
    ...
    return (
        <ModalOverlay
            // Match the panel's durations: without these the backdrop's fade-out
            // finishes early and snaps back to opaque while the panel keeps sliding
            // (the dismiss flicker). React Aria unmounts the tree only when the
            // longest animation (the panel slide) ends.
            className="fixed inset-0 z-50 bg-black/50 data-[entering]:animate-in data-[entering]:duration-500 data-[entering]:fade-in-0 data-[exiting]:animate-out data-[exiting]:duration-300 data-[exiting]:fade-out-0"
