    ...
    return (
        <AriaHeading className="flex">
            <AriaButton
                className={composeRenderProps(className, className =>
                    cx(
                        "flex flex-1 items-start justify-between gap-4 rounded-md py-4 text-left text-sm font-medium transition-all outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[focus-visible]:border-ring data-[focus-visible]:ring-[3px] data-[focus-visible]:ring-ring/50 data-[hovered]:underline [&[data-expanded]>svg]:rotate-180",
                        className,
                    ),
                )}
